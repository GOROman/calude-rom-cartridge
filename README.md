...
- 外形: 純正シェル互換の段付き外形（最大90×56.8mm、主要部90×46.1mm）、板厚1.2mm、60ピンエッジ
- デバッグ: J3 60ピン・2列メスコネクタをバス直結で実装可能（ケース組み込み時はDNP）
...
| J3 | 2×30ピン メスコネクタ、2.54mmピッチ | 1 | 60ピンバスのデバッグ用パススルー。ケース組み込み時は未実装（DNP） |
...
| 0Ω抵抗 | 0Ω | 2 | カートリッジ音声端子45–46の接続と、ピン31電源接続のオプション設定 |
| 60ピン・エッジコネクタ | 金メッキ基板端子 | 1 | ファミコン本体のCPU/PPUバス、電源、音声、CIRAM信号へ接続 |
