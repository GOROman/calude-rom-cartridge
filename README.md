...
採用しています。NROM/CNROMに対応し、ES8388によるI2S音声ミックスと
...
- 音声: M5Stamp S3のI2S → ES8388 → カートリッジ音声端子45/46へミックス（オプション、未実装でも動作）
...
| U20 | ES8388 | 1 | M5Stamp S3のI2Sをアナログ音声へ変換。45/46番端子へのミックス回路を含むオプション実装 |
...
- **I2S音声**: ES8388を使用する構成では、M5Stamp S3のI2S音声を端子45/46へミックス
